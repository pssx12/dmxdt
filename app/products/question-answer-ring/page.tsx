...
const details = [
  ['제품명', '117 QUESTION / ANSWER 링'],
  ['소재', PRODUCT.material],
  ['색상', '샴페인 골드'],
  ['스톤', '레드 젬 1개 · 지름 1.5mm 목표'],
  ['기준 사이즈', 'KS 신형 14호 · 목표 내주 57.6mm'],
  ['구조', '고정형 오픈링 · 중앙 오픈 간격 목표 4.0mm'],
      ...
      <main className="min-h-screen bg-[#050505] px-6 pb-24 pt-10 text-[#f5f1e8] md:px-[6vw]">
        <div className="mx-auto max-w-6xl">
          <header className="flex items-center justify-between border-b border-white/10 pb-7">
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.24em] text-[#a49b90]">Jewelry · Design 117</span>
          </header>

          <section className="grid gap-12 py-14 lg:grid-cols-[1.08fr_0.92fr] lg:py-20">
            <div className="overflow-hidden bg-[#f2eee7]">
              <Image src="/products/question-answer-ring/catalog-primary.png" alt="DMXDT 117 QUESTION / ANSWER 샴페인 골드 오픈링" width={1254} height={1254} className="h-full w-full object-cover" priority />
            </div>
            <div className="lg:py-6">
              <p className="dmxdt-eyebrow">DMXDT · Design 117</p>
              ...
              <p className="mt-8 border-y border-white/10 py-7 text-base leading-8 text-[#cfc7bc]">물음과 답 사이의 열린 간격을 하나의 형태로 만든 DMXDT의 18K 오픈링입니다. 물음표 곡선 끝에는 레드 젬 한 점을 두고, 반대편은 절제된 평면 바로 마감합니다.</p>
              <div className="mt-8 border border-[#c47a3a]/50 bg-[#c47a3a]/10 p-5 text-sm leading-7 text-[#d8c8b7]">현재 PG 심사 및 샘플 제작 준비 단계입니다. 표시 가격은 공개 배포 전 대표 승인이 필요합니다.</div>
          ...
          <section className="overflow-hidden border-y border-white/10 py-16">
            <Image src="/products/question-answer-ring/campaign-hero.png" alt="검은 석재 위에 놓인 DMXDT 117 QUESTION / ANSWER 링" width={1672} height={941} className="w-full" />
          </section>
