      ...
      <main className="min-h-screen bg-[#050505] px-6 pb-24 pt-10 text-[#f5f1e8] md:px-[6vw]">
        <div className="mx-auto max-w-6xl">
          ...
          <section className="grid gap-12 py-14 lg:grid-cols-[1.08fr_0.92fr] lg:py-20">
            <div>
              <div className="overflow-hidden bg-[#f2eee7]">
                <Image src="/products/design-22-eye-ring/catalog-primary.png" alt="DMXDT DESIGN 22 샴페인 골드 눈반지" width={1254} height={1254} className="h-full w-full object-cover" priority />
              </div>
          ...
          <section className="overflow-hidden border-y border-white/10 py-16">
            <Image src="/products/design-22-eye-ring/campaign-hero.png" alt="검은 석재 위의 DMXDT DESIGN 22 눈반지 광고 이미지" width={1672} height={941} className="w-full" />
          </section>
