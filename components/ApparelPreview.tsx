      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid gap-px overflow-hidden border border-white/10 bg-white/10 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="bg-[#0b0b0b] p-8 md:p-12">
            ...
            <a href="/products/design-22-eye-ring" className="mt-8 inline-flex border border-[#c47a3a] px-6 py-4 text-xs font-black uppercase tracking-[0.2em] text-[#f5f1e8] transition hover:bg-[#c47a3a] hover:text-[#050505]">View First Jewelry</a>
          </div>
        </div>
      </div>
    </section>
